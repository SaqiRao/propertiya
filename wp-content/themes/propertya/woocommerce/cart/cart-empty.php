...
<section class="empty-cart-page"></section>
        ...
        if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
            <div class="return-to-shop retutn-shopz">
                <a class="button wc-backward btn btn-theme" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
                    <?php esc_html_e( 'Return to shop', 'propertya' ); ?>
                </a>
            </div>
        <?php endif; ?>
        <img src="<?php echo esc_url(trailingslashit( get_template_directory_uri () ) . "libs/images/emptycart.png"); ?>" class="d-block mx-auto mb-4" alt="">
    </div>
</div>