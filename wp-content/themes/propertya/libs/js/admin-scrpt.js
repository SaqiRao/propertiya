...
var chk_container =  document.getElementById('property_map');
		if (typeof(chk_container) !== 'undefined' && chk_container !== null && get_map_string.is_map_enabled == 1)
		{
			
			 var map_lat =  get_map_string.map_latt;
			 var map_long = get_map_string.map_long;
