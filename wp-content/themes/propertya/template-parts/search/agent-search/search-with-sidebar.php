<?php
	...
	{
		$type =  trim($_GET['by_type']);
	}
    $layout_type = '';
    if(isset($_GET['agent-layout']) && ($_GET['agent-layout']!=""))
    {
        $layout_type = trim($_GET['agent-layout']);
    }
?>
<section class="agency-1 agent-section overflow-xs">
  <div class="container">
    <div class="row">
      <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
        <aside class="agent-sidebar custom-padding">
          <div class="sidebar-widget">
            <div class="widget-heading">
              <h2><?php echo esc_html__('Find Agents','propertya'); ?></h2>
            </div>
            <div class="form-submit">
              <form method="post" id="myagents_search">
            ...
            <div class="typeahead__field">
               ...
               <div class="form-group">
                <select data-placeholder="<?php echo esc_attr__('Search By Type', 'propertya'); ?>" name="by_type" class="search-selects form-control">
                    <?php propertya_framework_terms_options('agent_types' , $type); ?>
                </select>
               </div>
               <div class="form-group">
                <select data-placeholder="<?php echo esc_attr__('Search By Location', 'propertya'); ?>" name="by_location" class="search-selects form-control">
                    <?php propertya_framework_terms_options('agent_location' ,$location); ?>
                </select>
               </div>
          ...
          <?php
		  if (is_active_sidebar('prop_agents_seach_bar'))
		  {
			  dynamic_sidebar('prop_agents_seach_bar');
		  }
		  ?>
        </aside>
      </div>
