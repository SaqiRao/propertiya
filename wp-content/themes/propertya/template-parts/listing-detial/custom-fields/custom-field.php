...
if(class_exists('ACF') && function_exists('get_field_objects')) 
{
        ...
        $cus_fields = get_field_objects($property_id);
...
?>
<div class="widget-seprator prop-acf-custom">
        <div class="widget-seprator-heading">
                 <h3 class="sec-title"><?php echo esc_html(propertya_strings('prop_custom_views')); ?></h3>
        </div>
        <?php
                           ...
                           <div class="spk-3">
                                  ...
                                  <h6>
                                          <?php 
                                                if($data['type'] == 'url')
                                                {
                                                        echo '<a href="'.esc_url($data['value']).'" target="_blank">'.esc_html__('Link','propertya').'</a>';
                                                }
...
<?php
                foreach($custom_data as $data)
                {
                        ...
                        {
                        ?>      
                                <div class="widget-seprator prop-acf-custom-textarea clearfix">
                                        <div class="widget-seprator-heading">
                                                 <h3 class="sec-title"><?php echo esc_html($data['label']); ?></h3>
                                        </div>
                        ...
                        {
                        ?>
                                <div class="widget-seprator prop-acf-custom-multiple listing-features clearfix">
                                        <div class="widget-seprator-heading">
                                                 <h3 class="sec-title"><?php echo esc_html($data['label']); ?></h3>
                                        </div>
                        ...
                        {
                        ?>
                                <div class="widget-seprator prop-acf-custom-checkbox listing-features clearfix">
                                        <div class="widget-seprator-heading">
                                                 <h3 class="sec-title"><?php echo esc_html($data['label']); ?></h3>
                                        </div>
                                        <ul class="list-unstyled">
