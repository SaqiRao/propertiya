        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><?php echo esc_html($localization['expired']);?></h4>
				  <?php
                        //pagination
						$per_page = 10;
                        ...
                        $get_args = propertya_framework_fetch_user_listings('expired',$owner_id,$paged, $per_page, $keyword,false,true);
                        $my_listings = new WP_Query( $get_args );
                        if ( $my_listings->have_posts() )
                        {
                  ?>
                  <div id="warning-messages" class="alert custom-alert custom-alert--danger margin-bottom-30" role="alert">
                            <div class="custom-alert__top-side">
                                <span class="alert-icon custom-alert__icon  fas fa-exclamation-triangle"></span>
                                    <div class="custom-alert__body">
                                            ...
                                            <?php echo esc_html__('Properties were no longer visible for public view. It no longer appears in search or home.','propertya'); ?>
                                            </div>
                                    </div>
                             </div>
                        </div>
                            ...
                            <table class="custom-tabel">
                                ...
                                <tr id="<?php echo esc_attr($property_id); ?>" data-row-id="<?php echo esc_attr($property_id); ?>">
                                    ...
                                    <span class="action-icons-admin">
                                     <a  class="tool-tip reactive-my-listings" href="javascript:void(0)" data-property-id="<?php echo esc_attr($property_id);?>"  title="<?php echo esc_attr__('Re Active','propertya'); ?>"><i class="fas fa-sync-alt text-warning"></i>
                                    </a>
                                    <a class="tool-tip delete-my-prop" href="javascript:void(0)" data-property-id="<?php echo esc_attr($property_id);?>" title="<?php echo esc_attr__('Delete','propertya'); ?>"><i class="far fa-trash-alt text-danger"></i>
                                    </a>
                                    </td>
                                </tr>
                                <?php
