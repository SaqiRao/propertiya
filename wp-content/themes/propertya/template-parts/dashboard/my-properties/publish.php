        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><?php echo esc_html($localization['publish']);?></h4>
				  <?php
                        //pagination
						$per_page = 10;
                        ...
                        $get_args = propertya_framework_fetch_user_listings('publish',$owner_id,$paged, $per_page, $keyword);
                  		...
                  		<div class="table-responsive custom-tabel-label">
                            <table class="custom-tabel">
                                ...
                                <tr id="<?php echo esc_attr($property_id); ?>" data-row-id="<?php echo esc_attr($property_id); ?>">
                                	<td>
                                     <span class="admin-listing-img">
                                         <a href="<?php echo esc_url(get_the_permalink($property_id)); ?>">
                                                <img class="img-fluid" src="<?php echo propertya_framework_img_src($all_idz,'thumbnail'); ?>" alt="<?php echo esc_attr(get_post_meta($all_idz, '_wp_attachment_image_alt', TRUE)); ?>"></a>
                                     </span>
                                    </td>
                                    ...
                                    <td>
                                        <?php 
                                      $listing_expiry= get_post_meta($property_id, 'prop_regular_listing_expiry_date', true );
                                       
                                        
                                        //print_r($listing_expiry);
                                        if(($listing_expiry == "" )){
                                            echo "N/A";
                                        }elseif($listing_expiry == "-1"){
                                            echo "Unlimited";
                                        }else{

                                         echo get_post_meta($property_id, 'prop_regular_listing_expiry_date',  true); 
                                        }
                                        ?>
                                    </td>
                                    <td class="text-right">
