...
class SearchBuilder_Two extends Widget_Base {
	
	public function get_name() {
		return 'search-builder2';
	}
	
	public function get_title() {
		return __( 'Advanced Search Builder 2', 'propertya-elementor' );
	}
	...
	protected function register_controls() {
		...
		$params['filter_array'] = $settings['list'];
			echo propertya_elementor_search_builder2($params);
		}
/**
