...
class CallAction_One extends Widget_Base {
	
	public function get_name() {
		return 'call-action-one';
	}
	
	public function get_title() {
		return __( 'Call To Action 1', 'propertya-elementor' );
	}
	...
	protected function register_controls() {
		...
		$params['sec_btn']['nofollow'] = $settings['second_btn_link']['nofollow'];
			echo propertya_elementor_call_to_action_one($params);
		}
	/**
