...
class Testimonials3 extends Widget_Base {
	
	public function get_name() {
		return 'testimonial-three';
	}
	
	public function get_title() {
		return __( 'Testimonials Classic', 'propertya-elementor' );
	}
	...
	protected function register_controls() {
		...
		$params['blocks'] = $blocks;
			echo propertya_elementor_testimonials_3($params);
			if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
			?>
            <script>
				jQuery('.testimonial-classic').owlCarousel({
					loop:true,
					autoplay:true,
					dots:false,
