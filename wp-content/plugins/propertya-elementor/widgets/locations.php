...
class Locations extends Widget_Base {
	...
	public function get_name() {
		return 'prop-selective-locations';
	}
	
	public function get_title() {
		return __( 'Locations', 'propertya-elementor' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'description' => __( 'Recommended image size 270x430', 'propertya-elementor' ),
			]
		);
		...
		$params['locations'] = $blocks;
			echo propertya_elementor_selective_locations($params);
		}
