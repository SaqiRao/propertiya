...
class SearchBuilder extends Widget_Base {
	
	public function get_name() {
		return 'search-builder1';
	}
	
	public function get_title() {
		return __( 'Advanced Search Builder', 'propertya-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
            'sec_text',
            [
                'label' => __( 'Section Text', 'propertya-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Advanced Search', 'propertya-elementor' ),
				'label_block'=>false,
            ]
        );
		$this->add_control(
		...
		$this->add_control(
            'btncolumn_size',
            [
                'label' => __( 'Button Column Size', 'propertya-elementor' ),
		...
		$params['sec_text'] = $settings['sec_text'];
		...
		$params['filter_array'] = $settings['list'];
			...
			echo propertya_elementor_search_builder($params);
		}
/**
